...
def device(bot: Bot, update: Update):
  ...
  with urllib.request.urlopen("https://raw.githubusercontent.com/ConquerOS-Devices/ota/master/devices.json") as url:
...
__help__ = """
 - /device:{word} Search on our device list if you device is there. example: /device mido.\n
 - /devicelist: See the amount of devices available 
"""

__mod_name__ = "ConquerOS Devices List"
